...
__decorate([
    (0, swagger_1.ApiProperty)({ type: [Number], description: 'ID клінік, де працює' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsNumber)({}, { each: true }),
    __metadata("design:type", Array)
], CreateDoctorDto.prototype, "clinics", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: [Number], description: 'ID послуг, які надає' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsNumber)({}, { each: true }),
    __metadata("design:type", Array)
], CreateDoctorDto.prototype, "services", void 0);
