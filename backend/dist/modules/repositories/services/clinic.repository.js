...
let ClinicRepository = class ClinicRepository extends typeorm_1.Repository {
    dataSource;
    constructor(dataSource) {
        super(clinic_entity_1.ClinicEntity, dataSource.createEntityManager());
        this.dataSource = dataSource;
    }
    async findByNamePart(name) {
